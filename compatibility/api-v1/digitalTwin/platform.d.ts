...
export interface PhysicsEngine {
    readonly info: PlatformAdapterInfo;
    step(context: DigitalTwinContext, state: RobotState, durationMs: number): RobotState | Promise<RobotState>;
}
export interface SimulationRuntime {
    readonly info: PlatformAdapterInfo;
    run(context: DigitalTwinContext, timeline: TwinTimeline): void | Promise<void>;
}
...
export interface FleetVisualization {
    readonly info: PlatformAdapterInfo;
    render(contexts: readonly DigitalTwinContext[], states: readonly RobotState[]): void | Promise<void>;
}
