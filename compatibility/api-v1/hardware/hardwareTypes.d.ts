...
export declare const HARDWARE_ADAPTER_STATUSES: readonly ["ready", "degraded", "faulted", "offline"];
export type HardwareAdapterStatus = (typeof HARDWARE_ADAPTER_STATUSES)[number];
